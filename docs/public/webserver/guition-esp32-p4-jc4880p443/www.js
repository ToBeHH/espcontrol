...
(function () {
  ...
  var CSS =
    ...
    ".sp-back-btn .sp-btn-icon{font-size:4.69cqw;line-height:1;color:#fff}" +
    ".sp-back-btn .sp-btn-label{font-size:1.8cqw;line-height:1.2;color:#fff}" +

    // Subpage chevron overlay on home buttons
    ".sp-subpage-badge{position:absolute;bottom:1cqw;right:1cqw;font-size:2cqw;opacity:.5}";
